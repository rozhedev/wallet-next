...
import StoreAssetItem, { type TStoreAssetsItem, storeAssetsItemArr } from "@/components/items/StoreAssetsItem";
            ...
            <div className="inner">
                ...
                <StyledWrapper className="cabinet-card assets-cab-store">
                    ...
                    <div className="assets-cab-store__content">
                        {storeAssetsItemArr.map((item: TStoreAssetsItem<TAllCurNotesScope>) => (
                            <StoreAssetItem
                                key={item.id}
                                id={item.id}
                                curIconPath={item.curIconPath}
