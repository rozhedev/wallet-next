        ...
        <SectionLayout id="terms">
            ...
            <div className="page-inner">
                ...
                <ol className="ordered-list ordered-list--privacy1">
                    ...
                    <li>
                        By registering on the {rulesContent.projectDomain} website managed by {projectNames.flemWalletLtd} based in London, you agree and fully accept the following Terms and
                ...
                <ol className="ordered-list ordered-list--privacy2">
                    <li>The deposit is a private agreement between London based {projectNames.flemWalletLtd} and the user.</li>
